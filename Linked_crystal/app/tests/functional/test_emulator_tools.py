...
class TestEmulatorTools(unittest.TestCase):
    def setUp(self):
        ...
        # Mock Emulator instance returned by interface
        self.mock_emulator = MagicMock()
        self.mock_emu_core.return_value = self.mock_emulator
        ...
        self.screen.ids.link_info_label = MagicMock()
    ...
    def test_on_enter_initialization(self):
        ...
        self.mock_emulator.start.assert_called()
